  ...
  return (
    <header className='hero'>
      <div className='hero-content'>
        ...
        <h1>Premium Hydration,<br />Delivered in Ariyalur.</h1>
        <p>Crystal-clear purity in every drop. Purified through 7-stage RO technology and delivered fresh to your doorstep.</p>
